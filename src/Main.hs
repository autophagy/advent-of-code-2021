...
getSolution "1" = Just (MkWrappedSolution Day01.solution, "data/day01.txt")
getSolution "2" = Just (MkWrappedSolution Day02.solution, "data/day02.txt")
getSolution "3" = Just (MkWrappedSolution Day03.solution, "data/day03.txt")
getSolution "4" = Just (MkWrappedSolution Day04.solution, "data/day04.txt")
getSolution "5" = Just (MkWrappedSolution Day05.solution, "data/day05.txt")
getSolution "6" = Just (MkWrappedSolution Day06.solution, "data/day06.txt")
getSolution "7" = Just (MkWrappedSolution Day07.solution, "data/day07.txt")
getSolution "8" = Just (MkWrappedSolution Day08.solution, "data/day08.txt")
getSolution "9" = Just (MkWrappedSolution Day09.solution, "data/day09.txt")
